...
$(PLATFORM_CABAL_EXE): $(PLATFORM_GHC) $(CABAL_INST_TARBALL)		\
		       $(ZLIB_TARGET) $(HTTP_TARGET) $(CABAL_TARGET) $(RANDOM_TARGET)
...
$(TEXT_TARGET): $(TEXT_TARBALL)
	$(call build_cabal_target,$(TEXT_TARBALL),text,$(TEXT_VERSION))

$(PARSEC_TARGET): $(PARSEC_TARBALL) $(MTL_TARGET) $(TEXT_TARGET)
	$(call build_cabal_target,$(PARSEC_TARBALL),parsec,$(PARSEC_VERSION))

$(TRANS_TARGET): $(TRANS_TARBALL)
	$(call build_cabal_target,$(TRANS_TARBALL),transformers,$(TR_VERSION))

$(RANDOM_TARGET): $(RANDOM_TARBALL) $(RANDOM_TARGET)
	$(call build_cabal_target,$(RANDOM_TARBALL),random,$(RANDOM_VERSION))

$(MTL_TARGET): $(MTL_TARBALL) $(TRANS_TARGET)
...
$(TEXT_TARBALL): $(TARBALL_DIR_STAMP)
	wget $(TEXT_LINK) -O $(TEXT_TARBALL)
	$(TOUCH) $(TEXT_TARBALL)
...
$(TRANS_TARBALL): $(TARBALL_DIR_STAMP)
	wget $(TRANS_LINK) -O $(TRANS_TARBALL)
	$(TOUCH) $(TRANS_TARBALL)
...
$(RANDOM_TARBALL): $(TARBALL_DIR_STAMP)
	wget $(RANDOM_LINK) -O $(RANDOM_TARBALL)
	$(TOUCH) $(RANDOM_TARBALL)
